...
//			),
            ...
            'backend' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/backend[/:controller][/:action][/:id][/page/:page][/type/:type][/sort/:sort][/order/:order][/textSearch/:textSearch]',
                    'constraints' => array (
                        'controller'    => '[a-zA-Z][a-zA-Z0-9_-]*',
//                        'action'        => '[a-zA-Z][a-zA-Z0-9_-]*',
    ...
    'controllers' => array(
        'invokables' => array(
            ...
            'Backend\Controller\News'       => 'Backend\Controller\NewsController'
        ),
    ),
    'view_helpers' => array(
    		'invokables' => array(
