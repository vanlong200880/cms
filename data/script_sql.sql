...
CREATE TABLE IF NOT EXISTS `cms`.`category_language` (
  ...
  PRIMARY KEY (`id`, `language_id`, `category_id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `cms`.`product` (
  ...
  `category_id` INT(11) UNSIGNED NOT NULL COMMENT '',
  PRIMARY KEY (`id`, `trademark_id`, `supplier_id`, `shop_id`, `category_id`)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `cms`.`comment` (
  ...
  PRIMARY KEY (`id`, `product_id`, `user_id`)  COMMENT '',
  INDEX `fk_comment_product1_idx` (`product_id` ASC)  COMMENT '',
...
CREATE TABLE IF NOT EXISTS `cms`.`order` (
  ...
  `payment_method_id` INT UNSIGNED NOT NULL COMMENT '',
